"""gm/ID optimizer for common-source amplifier with PMOS active load.
...
class Circuit:
    ...
    MOSFETS: ClassVar[list[Instance]] = [
        ...
        Instance("M2", "pmos", d="VOUT", g="vb", s="vdd", b="vdd"),
    ]
    ...
    def compute_vsource_params(self, _opt_params: dict[str, float]) -> dict[str, float]:
        ...
        VB = self.vdd - ops.get("M2", {}).get("VGS", 0.0)
        return {"VB": VB}
