...
OUTPUT_MODULE = "./pmos_miller_simple.scs"
...
PARAMETERS = [
    ...
    OptimizationParameter("Mvbp_mult", (0.2, 3.0)),
    ...
    OptimizationParameter("M3_L", (LMIN, LMAX)),
    OptimizationParameter("M4_L", (LMIN, LMAX)),
]
