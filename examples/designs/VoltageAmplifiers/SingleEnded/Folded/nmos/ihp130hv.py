...
OUTPUT_MODULE = "./nmos_folded_wide-swing.scs"
...
PARAMETERS = [
    OptimizationParameter('M5a_ID_over_M1a_ID', (1.0, 8.0)),
    OptimizationParameter('M5a_VDSAT_MARGIN', (0.3, 0.8)),
    OptimizationParameter('M2a_VDSAT_MARGIN', (0.3, 0.8)),
    OptimizationParameter('M1a_ID', (5e-06, 20e-06)),
    OptimizationParameter('M1a_GMID', (10.0, 20.0)),
    OptimizationParameter('M1a_L', (LMIN, LMAX)),
    OptimizationParameter('M2a_GMID', (10.0, 20.0)),
    OptimizationParameter('M2a_L', (LMIN, LMAX)),
    OptimizationParameter('M3a_GMID', (10.0, 20.0)),
    OptimizationParameter('M3a_L', (LMIN, LMAX)),
    OptimizationParameter('M4a_GMID', (10.0, 20.0)),
    OptimizationParameter('M4a_L', (LMIN, LMAX)),
    OptimizationParameter('M5a_GMID', (10.0, 20.0)),
    OptimizationParameter('M5a_L', (LMIN, LMAX)),
    OptimizationParameter('M6_GMID', (10.0, 20.0)),
    OptimizationParameter('M6_L', (LMIN, LMAX)),
]
