...
OUTPUT_MODULE = "/home/medwatt/git/gmid_designs_tb/ihp130hv/nmos_folded_wide-swing.scs"
...
PARAMETERS = [
    ...
    OptimizationParameter('M5a_L', (4e-07, 1e-05)),
    OptimizationParameter('M6_GMID', (10.0, 20.0)),
    OptimizationParameter('M6_L', (4e-07, 1e-05)),
]
