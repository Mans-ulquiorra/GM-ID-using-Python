...
class Circuit:
    ...
    MOSFETS: ClassVar[list[Instance]] = [
        ...
        Instance("M2a", "pmos", d="n04", g="vcascp", s="n01", b="vdd"),
        Instance("M2b", "pmos", d="VOUT", g="vcascp", s="n03", b="vdd"),
        Instance("M3a", "nmos", d="n04", g="vcascn", s="n05", b="gnd"),
        Instance("M3b", "nmos", d="VOUT", g="vcascn", s="n06", b="gnd"),
        Instance("M4a", "nmos", d="n05", g="n04", s="gnd", b="gnd"),
        Instance("M4b", "nmos", d="n06", g="n04", s="gnd", b="gnd"),
        Instance("M5", "pmos", d="n02", g="vbp", s="vdd", b="vdd"),
    ]
