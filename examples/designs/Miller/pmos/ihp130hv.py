...
OUTPUT_MODULE = "/home/medwatt/git/gmid_designs_tb/ihp130hv/pmos_miller_simple.scs"
...
PARAMETERS = [
    ...
    OptimizationParameter("M3_L", (4e-07, 1e-05)),
    OptimizationParameter("M4_GMID", (10.0, 20.0)),
    OptimizationParameter("M4_L", (4e-07, 1e-05)),
]
