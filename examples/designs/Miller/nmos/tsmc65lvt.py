...
NMOS_NAME = "nch_lvt"
PMOS_NAME = "pch_lvt"
OUTPUT_MODULE = "/home/medwatt/git/gmid_designs_tb/tsmc65lvt/nmos_miller_simple.scs"
...
PARAMETERS = [
    OptimizationParameter("W5_over_W3", (1.0, 8.0)),
    OptimizationParameter("M3_mult", (1.0, 8.0)),
    OptimizationParameter("CC", (1e-13, 2e-12)),
    OptimizationParameter("Rz", (100, 10000)),
    OptimizationParameter("M1a_ID", (5e-06, 20e-05)),
    OptimizationParameter("M1a_GMID", (10.0, 20.0)),
    OptimizationParameter("M1a_L", (1e-07, 1e-05)),
    OptimizationParameter("M2a_GMID", (10.0, 20.0)),
    OptimizationParameter("M2a_L", (1e-07, 1e-05)),
    OptimizationParameter("M3_GMID", (10.0, 20.0)),
    OptimizationParameter("M3_L", (1e-07, 1e-05)),
    OptimizationParameter("M4_GMID", (10.0, 20.0)),
    OptimizationParameter("M4_L", (1e-07, 1e-05)),
]
