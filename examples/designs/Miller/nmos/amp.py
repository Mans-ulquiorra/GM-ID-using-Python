...
class Circuit:
    ...
    MOSFETS: ClassVar[list[Instance]] = [
        Instance("M1a", "M1a", d="n01", g="VINN", s="n02", b="gnd"),
        Instance("M1b", "M1b", d="n03", g="VINP", s="n02", b="gnd"),
        Instance("M2a", "M2a", d="n01", g="n01", s="vdd", b="vdd"),
        Instance("M2b", "M2b", d="n03", g="n01", s="vdd", b="vdd"),
        Instance("M3", "M3", d="n02", g="gnd", s="gnd", b="gnd"),
        Instance("M4", "M4", d="VOUT", g="n03", s="vdd", b="vdd"),
        Instance("M5", "M5", d="VOUT", g="gnd", s="gnd", b="gnd"),
    ]
    ...
    NETLIST_MOSFETS: ClassVar[list[Instance]] = [
        ...
        Instance("M4", "M4", d="VOUT", g="n03", s="vdd", b="vdd"),
        Instance("M5", "M5", d="VOUT", g="vbn", s="gnd", b="gnd"),
    ]
